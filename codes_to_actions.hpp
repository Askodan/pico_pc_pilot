...
std::map<std::pair<uint8_t, uint8_t>, std::pair<uint8_t, uint32_t>> ActionsRC5 = {
{{0, 16}, {REPORT_ID_CONSUMER_CONTROL, HID_USAGE_CONSUMER_VOLUME_INCREMENT}},// increase volume
{{0, 17}, {REPORT_ID_CONSUMER_CONTROL, HID_USAGE_CONSUMER_VOLUME_DECREMENT}},// decrease volume
{{0, 60}, {REPORT_ID_CONSUMER_CONTROL, HID_USAGE_CONSUMER_PLAY_PAUSE}},
{{0, 35}, {REPORT_ID_CONSUMER_CONTROL, HID_USAGE_CONSUMER_PLAY_PAUSE}},
{{0, 126}, {REPORT_ID_CONSUMER_CONTROL, HID_USAGE_CONSUMER_STOP}},
{{0, 13}, {REPORT_ID_CONSUMER_CONTROL, HID_USAGE_CONSUMER_MUTE}},
{{0, 9}, {REPORT_ID_KEYBOARD, HID_KEY_9}},// key 9
{{0, 8}, {REPORT_ID_KEYBOARD, HID_KEY_8}},// key 9
{{0, 7}, {REPORT_ID_KEYBOARD, HID_KEY_7}},// key 9
{{0, 6}, {REPORT_ID_KEYBOARD, HID_KEY_6}},// key 9
{{0, 5}, {REPORT_ID_KEYBOARD, HID_KEY_5}},// key 9
{{0, 4}, {REPORT_ID_KEYBOARD, HID_KEY_4}},// key 9
{{0, 3}, {REPORT_ID_KEYBOARD, HID_KEY_3}},// key 9
{{0, 2}, {REPORT_ID_KEYBOARD, HID_KEY_2}},// key 9
{{0, 1}, {REPORT_ID_KEYBOARD, HID_KEY_1}},// key 9
{{0, 0}, {REPORT_ID_KEYBOARD, HID_KEY_0}},// key 9
};